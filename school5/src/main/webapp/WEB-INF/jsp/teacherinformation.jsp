...
<link  rel="stylesheet"  type="text/css"  href="css/studentRegisterB.css" />
...
$.messager.alert(title, msgString, msgType);
        ...
        function serverLogin() {
            ...
            var teacher = {"userNickname":$('#Username').val(),"role":"Role_Teacher","oldPassword":$('#txtOldPass').val(), "newPassword":$('#txtNewPass').val()};
            var str = JSON.stringify(teacher);
			$.ajax({  
		        type:"Post",
		        contentType:"application/json",
				url:"teacherChange.html",
				data:str,
		        dateType:"json",  
		        success:function(data){
        ...
        function telLogin() {
            ...
            if ($oldTel.val() == $newTel.val()) {
				...
				var teacher ={"userNickname":$('#Username').val(),"phone":$('#newTel').val(),"role":"Role_Teacher"};
				var str = JSON.stringify(teacher);
				$.ajax({  
		        type:"Post",
		        contentType:"application/json",
...
<div id="w" class="easyui-window" title="修改密码" collapsible="false" minimizable="false"
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                <table cellpadding=3>
                    <tr>
                        <td>昵称:</td>
                        <td><input id="userName" type="text" readonly="readonly" class="txt01" value=<sec:authentication property="principal.username"/> readonly="readonly" /></td>
                    </tr>
                    <tr>
                        <td>旧密码：</td>
    ...
    <div id="e" class="easyui-window" title="修改电话号码" collapsible="false" minimizable="false"
        ...
        <div class="easyui-layout" fit="true">
            ...
            <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
           <a id="qd" class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)"> 确定</a> 
           <a class="easyui-linkbutton" icon="icon-cancel" href="javascript:void(0)" id="close2">清空</a>
            </div>
        </div>
    </div>
<div id="form"  style="padding:10px   10px  9px  60px;margin:10px  auto  9px  auto;width:410px;border:solid 2px #91b5e7;height:370px;" >
<h2  class="login_txt_bt">欢迎普通教师修改</h2>

  <p>
    	<span ><img src="images/nc.png" width="120" height="24" /></span>
        <input  type="text"  id="nickName"  value=<sec:authentication property="principal.username"/>   name="nickName1"  size="25"    readonly="readonly" class="easyui-validatebox"/>  
    		</p>
        ...
        <input type="text"  id="teacherCardId"   name="shenfenzheng"  size="25"  readonly="readonly" class="easyui-validatebox"/>
	    </p>


        <p>
    	<span ><img src="images/jsxm.png" width="120" height="24" /></span>
        <input  type="text" id="teacherName"  name="teacherName1"   size="25"  readonly="readonly" class="easyui-validatebox"/>
		</p>

         <p>

    	<span >
    	<img src="images/sjhm.png" width="120" height="24" /></span>
    	

         <input type="text" id="teacherPhone"  name="mobile" size="25"  readonly="readonly" class="easyui-validatebox"/>
		 </p>
