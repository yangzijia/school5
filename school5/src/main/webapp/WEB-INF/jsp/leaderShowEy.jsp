...
$('#cc').combobox({    
    ...
    editable:false  
        ...
        columns:[[ 
            ...
            {field:'studentNumber',title:'学生学号',width:80} ,
   	...
   	function getData(){
   		...
   		var str = JSON.stringify(obj);
			$.ajax({
				...
				data:str,
				url:'LeadergetEmergencyByGrade.html',
				async :false,
				dataType:'json',
   	...
   	function getData(){
   		...
   		var str = JSON.stringify(obj);
			$.ajax({
				...
				contentType:'application/json',
				data:str,
				url:'LeadergetEmergencyByType.html',
				async :false,
				dataType:'json',
				success:function(data){
				if(data.Status=="Fail"){
...
$(document).ready(function() {
    ...
    <table id="dg"></table>
       	...
       	<!-- 学院: <select id="college"  style="width:140px">
		 </select>&nbsp;&nbsp;	 
		年级:<select id="yearClass"  style="width:80px">
		  </select>&nbsp;&nbsp;	
		 专业:<select id="profession"  style="width:140px">
		   </select>&nbsp;&nbsp;	
