...
$(document).ready(function(){
	$.ajax({
			type:'Post',
			url:'leaderWebShow.html',
			async:'false',
			dataType:'json',
			success:function(data){
				$('#leaderName').val(data.name);
				$('#leaderPhone').val(data.phone);				
...
$.messager.alert(title, msgString, msgType);
        ...
        function serverLogin() {
            ...
            var leader={"userNickname":$('#Username').val(),"role":"Role_Leader","oldPassword":$('#txtOldPass').val(),"newPassword":$('#txtNewPass').val()};
            var str = JSON.stringify(leader);
			$.ajax({  
		        type:"Post",
		        contentType:"application/json",
				url:"leaderChange.html",
				data:str,
		        dateType:"json",  
		        success:function(data){
        ...
        function telLogin() {
            ...
            var leader ={"userNickname":$('#Username').val(),"phone":$('#newTel').val(),"role":"Role_Leader"};
				var str = JSON.stringify(leader);
				$.ajax({  
		        type:"Post",
		        contentType:"application/json",
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                <table cellpadding=3>
                    <tr>
                        <td>昵称:</td>
                        <td><input id="UserName" value=<sec:authentication property="principal.username"/>  type="text"  class="txt01" readonly="readonly" /></td>
                    </tr>
                    <tr>
                        <td>旧密码：</td>
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                <table cellpadding=3>
                    <tr>
                        <td>昵称:</td>
                        <td><input id="Username" type="text" class="txt01" readonly="readonly" value=<sec:authentication property="principal.username"/> /></td>
                    </tr>
                    <tr>
                        <td>旧电话号码:</td>
...
<h2  class="login_txt_bt">欢迎领导修改</h2>
...
<p>
    	<span ><img src="images/ldxm.png" width="120" height="24"></span>
        <input  type="text"   id="leaderName"  size="25"  readonly="readonly" class="easyui-validatebox"  name="textfield2"  />
	</p>

	<p>
    	<span ><img src="images/sjhm.png" width="120" height="24"></span>
        <input  type="text"   id="leaderPhone"   name="textfield3"  size="25"  readonly="readonly" class="easyui-validatebox" />
	</p>
