...
$(document).ready(function(){
	$.ajax({
				...
				url:'headTeacherGetEmergencyByStudentNumberAndMapId.html',
				async :false,
				dataType:'json',
				success:function(data){
					$('#studentName').val(data.studentName);
					$('#studentNumber').val(data.studentNumber);
					$('#yearClass').val(data.yearClass);
 ...
 <div id="mainPanle" scrolling="no" region="center">
  <div  class="left"  >       
    	...
    	<span ><img src="images/xsxh.png" width="120" height="24" /></span>
         <input type="text" id="studentNumber"  name="" size="20" readonly="readonly" class="easyui-validatebox"/>
	             </p>
				  <p>
    	<span ><img src="images/xsxm.png" width="120" height="24" /></span>
         <input type="text" id="studentName"  name="" size="20" readonly="readonly" class="easyui-validatebox"/>
	             </p>
				  <p>
    	<span ><img src="images/xsnj.png" width="120" height="24" /></span>
         <input type="text" id="yearClass"  name="" size="20" readonly="readonly" class="easyui-validatebox"/>
	             </p>
				  <p>
    	<span ><img src="images/xszy.png" width="120" height="24" /></span>
         <input type="text" id="profession"  name="" size="20" readonly="readonly" class="easyui-validatebox"/>
	             </p>
				  <p>
    	<span ><img src="images/xsbj.png" width="120" height="24" /></span>
         <input type="text" id="studentClass"  name="" size="20" readonly="readonly" class="easyui-validatebox"/>
	             </p>
                   <p>
    	<span ><img src="images/sjhm.png" width="120" height="24" /></span>
         <input type="text" id="studentPhone"  name="" size="20" readonly="readonly" class="easyui-validatebox"/>
	             </p>             
                 <span ><img src="images/lyb.png" width="120" height="24" /></span><br />
                 <textarea id="word" readonly="readonly" style="width:300px;height:100px;margin-top:10px;">                 
               </textarea>
