		...
		$('#accept_a').click(function(){
			if(endEditing()){
					...
					for(var i=0; i<rows.length; i++){
                         ...
                         var RoleName={"roleName":roleName,"remark":remark};
                         ss.push(RoleName);
					}
...
$(document).ready(function(){
                             ...
                             if (r) {
                                 ...
                                 for (var i = 0; i < rows1.length; i++) {
                                    var id = rows[i].id;
                                 	var roleName = rows[i].roleName;
                         			var remark = rows[i].remark;
                         			var RoleName={"id":id,"roleName":roleName,"remark":remark};
                         			ids.push(RoleName);
                                 }
                                var obj=ids;
                                var str=JSON.stringify(obj);
  ...
  <body style="overflow:hidden;">
 	<table id="dg">   
		...
		<thead>
			<tr>
            	<th data-options="field:'roleName',editor:{type:'validatebox',options:{required:true}}" width="80">权限标记</th>
