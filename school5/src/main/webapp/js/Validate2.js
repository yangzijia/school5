var validateRegExp = {
    ...
    studentCardId:"^[1-9]([0-9]{14}|[0-9]{17})$", //身份证
    ip4:"^(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)\\.(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)\\.(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)\\.(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)$", //ip地址
    letter:"^[A-Za-z]+$", //字母
    letter_l:"^[a-z]+$", //小写字母
    letter_u:"^[A-Z]+$", //大写字母
    studentPhone:"^0?(13|15|18)[0-9]{9}$", //手机
    notempty:"^\\S+$", //非空
...
var validateRules = {
    ...
    isstudentPhone:function (str) {
        return new RegExp(validateRegExp.studentPhone).test(str);
    },
isstudentCardId:function (str) {
        return new RegExp(validateRegExp.studentCardId).test(str);
    },
    ...
    isstudentName:function (str) {
        return new RegExp(validateRegExp.studentName).test(str);
    },
